   ...
   <td width="140" height="32" bgcolor="#FF0000"><div align="center" class="style2 style1"><span class="style3"><b>User Name</b> </span></div></td>
    ...
    <td width="205" bgcolor="#FF0000"><div align="center" class="style2 style1"><span class="style3"><b>DOB</b></span></div></td>
     <td width="178" bgcolor="#FF0000"><div align="center" class="style2 style1"><span class="style3"><b>Gender</b> </span></div></td>
           ...
           <td width="178" bgcolor="#FF0000"><div align="center" class="style2 style1"><span class="style3"><b>Status</b> </span></div></td>
  </tr>
	...
	while ( rs.next() )
	   {
		...
		String query1="select * from mpln_user where name='"+s113+"' "; 
			...
			%><tr>
					...
					<td><div align="center"><%=s2%></div></td>
							...
							<td><div align="center"><%=s8%></div></td>
								...
								<%if(s12.equalsIgnoreCase(uname))
								{
								%>
								<td><div align="center">Waiting For Response by <%=s13 %></div></td>
								<%
								}else
								{
								%>
								<td><div align="center"><a href="AcceptFriendRequest.jsp?id=<%=i %>&uname=<%=s2 %>">Accept Friend Request</a></div></td>
								<%
								}
								%>
