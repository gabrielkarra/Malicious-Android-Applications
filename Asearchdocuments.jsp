...
String decryptedValue0=null;
	   ...
	   String title=request.getParameter("kname").toLowerCase();
			...
			while ( rs.next() )
			   {
				...
				if(dec.contains(title))
				{

			      s66="Owner Name="+s2+","+"Doc Title="+decryptedValue0+"***"+"Doc Uses="+decryptedValue1+"***"+"Doc Name="+s5+"***"+"Doc Desc="+decryptedValue2+"***"+"Doc Rank="+s7+"***"+"Doc Date and Time="+s8+"***";
          		     al.add(s66);
