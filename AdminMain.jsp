...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Welcome Admin Main </span></h2>
          <p><img src="images/Admin.jpg" width="641" height="276" /></p>
          <div class="clr"></div>
        </div>
        </div>
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="ViewAllComments0.jsp">View All Comments</a></li>
             <li>
               <div align="justify"><a href="GetMaliciousUser.jsp"> View Malware Propagation User <br />
                Details</a></div>
            </li>
             <li><a href="ViewUser.jsp">View Users</a></li>
			 
			              <li><a href="ViewAndroidUser.jsp">View Android Users and Give Permission</a></li>
