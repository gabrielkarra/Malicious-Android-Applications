      ...
      <div class="mainbar">
        <div class="article">
          ...
          <div class="post_content">
              <form id="form1" name="form1" method="post" action="SearchContents1.jsp">
<table width="598" border="0" align="center">
	<p>&nbsp;</p>
	<p>&nbsp;</p>
	<tr>
		<td bgcolor="#FF0000" class="style4 style1">Enter KeyWord :-</td>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="SearchFile.jsp">Search Users</a></li>
             <li><a href="SearchContents.jsp">Search Files</a></li>
            <li><a href="ViewMyHistory.jsp">View My Search History</a></li>
            <li><a href="GetMalicious.jsp">Find Malicious Document</a></li>
            <li><a href="SendFriendRequest.jsp">Send Friend Request </a></li>
             <li><a href="ViewMyFriends.jsp">View My Friends</a></li>
