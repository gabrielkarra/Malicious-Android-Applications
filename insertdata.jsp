	...
	try {
		...
		while (files.hasMoreElements()) {
			...
			if (paramname != null) {
				...
				String query1 = "SELECT * FROM mpln_user WHERE name='"
						+ uname + "' ";
...
<%
					...
					PreparedStatement ps = connection
							.prepareStatement("INSERT INTO mpln_user(name,pass,email,mobile,addr,dob,gender,pin,location,imagess) values(?,?,?,?,?,?,?,?,?,?) ");
